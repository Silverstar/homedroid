...
//            WeatherCuxdView(v, hmc);
        ...
        // universal devices
        else if (type.equalsIgnoreCase("HmIP-WUA") ||
                type.equalsIgnoreCase("ELV-SH-WUA") ||
                type.equalsIgnoreCase("ELV-SH-WSC") ||
                type.equalsIgnoreCase("HmIP-STI") ||
                type.equalsIgnoreCase("HmIP-BS2") ||
                type.equalsIgnoreCase("ELV-SH-BS2") ||
                type.equalsIgnoreCase("HmIP-SMI55-2") ||
                type.equalsIgnoreCase("HmIP-RGBW") ||
                type.equalsIgnoreCase("HmIP-FWI")) {
        ...
        } else if (type.equals("HmIP-FBL") || type.startsWith("HmIP-BBL")) {
            if (hmc.channelIndex < 3) {
                TasterView(v, hmc);
            } else if (hmc.channelIndex == 3) {
        ...
        } else if (type.equals("HmIP-FROLL") || Util.startsWithIgnoreCase(type, "HmIP-BROLL")) {
            if (hmc.channelIndex < 3) {
                TasterView(v, hmc);
            } else if (hmc.channelIndex == 3) {
                BlindHeightIpView(v, hmc);
...
//        }
    ...
    private void DynamicDatapoints(View view, HMChannel hmc) {
            ...
            switch (datapoint.getPoint_type()) {
                ...
                case "MOTION":
                    ...
                    if (motion != null && motion) {
                        mViewAdder.addNewValue(view, R.drawable.flat_alarm, ViewAdder.IconSize.SMALL);
                    }
        ...
        if (((ViewGroup) view.findViewById(R.id.valueLL)).getChildCount() == 0) {
            NotSupportedView(view, hmc);
        }
    }
    ...
    private View GasMeterView(View v, HMChannel hmc) {
        ...
        if (iecEnergyCounter != null) {
            mViewAdder.addNewValue(v, R.drawable.flat_counter,
                    Double.toString(Math.round(iecEnergyCounter * 10) / 10.) + "kWh");
        }
