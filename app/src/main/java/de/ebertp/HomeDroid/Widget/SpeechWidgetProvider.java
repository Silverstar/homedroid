...
public class SpeechWidgetProvider extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int widgetId : allWidgetIds) {
            ...
            PendingIntent resultsPendingIntent = PendingIntent.getService(context, 0, resultIntent, PendingIntent.FLAG_IMMUTABLE);
            ...
            PendingIntent pendingIntent = PendingIntent.getActivity(context, 0, voiceIntent, PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_IMMUTABLE);
